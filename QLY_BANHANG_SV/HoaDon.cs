...
namespace QLY_BANHANG_SV
{
    public partial class HoaDon : Form
    {
        ...
        DataTable chitiethoadon; // bảng chi tiết hóa đơn bán
        private void HoaDon_Load(object sender, EventArgs e)
        {
            ...
            Functions.FillCombo("SELECT manv,tennv FROM nhanvien", cboMaNhanVien, "manv", "manv");
            cboMaNhanVien.SelectedIndex = -1;
            Functions.FillCombo("SELECT mahh, tenhh FROM hanghoa", cboMaHang, "mahh", "mahh");
        ...
        {
            string sql;
            sql = "SELECT a.mahh, b.tenhh, a.soluong,  b.giaban, a.giamgia, a.thanhtien  FROM chitiethoadon AS a, hanghoa AS b WHERE mahd=N'" + txtMaHDBan.Text + "' AND a.mahh=b.mahh";
            chitiethoadon = Functions.GetDataToTable(sql);
            dgvTKHoaDon.DataSource = chitiethoadon;
            dgvTKHoaDon.Columns[0].HeaderText = "Mã Hàng Hóa";
            dgvTKHoaDon.Columns[1].HeaderText = "Tên Hàng Hóa";
            dgvTKHoaDon.Columns[2].HeaderText = "Số Lượng";
            dgvTKHoaDon.Columns[3].HeaderText = "Đơn Giá";
            dgvTKHoaDon.Columns[4].HeaderText = "Giảm Giá";
            dgvTKHoaDon.Columns[5].HeaderText = "Thành Tiền";
            dgvTKHoaDon.Columns[0].Width = 100;
            dgvTKHoaDon.Columns[1].Width = 200;
            dgvTKHoaDon.Columns[2].Width = 100;
            dgvTKHoaDon.Columns[3].Width = 100;
            dgvTKHoaDon.Columns[4].Width = 100;
            dgvTKHoaDon.Columns[5].Width = 100;
        ...
        {
            string str;
            str = "SELECT ngayban FROM hoadon WHERE mahd = N'" + txtMaHDBan.Text + "'";
            ...
            str = "SELECT makhach FROM hoadon WHERE mahd = N'" + txtMaHDBan.Text + "'";
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            btnLuu.Enabled = true;
            ResetValue();
            txtMaHDBan.Text = Functions.CreateKey("HDB_");
            LoadDataGridView();
        }
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            sql = "SELECT mahd FROM hoadon WHERE mahd=N'" + txtMaHDBan.Text + "'";
            if (!Functions.CheckKey(sql))
            {
                ...
                sql = "INSERT INTO hoadon(mahd, manv, makhach, ngayban, tongtien) VALUES (N'" + txtMaHDBan.Text.Trim() + "',N'" + cboMaNhanVien.SelectedValue + "',N'" +
                        cboMaKhachHang.SelectedValue + "','" + Functions.ConvertDateTime(dtpNgayBan.Text.Trim()) + "'," + txtTongTien.Text + ")";
            ...
            sql = "SELECT mahh FROM chitiethoadon WHERE mahh=N'" + cboMaHang.SelectedValue + "' AND mahd = N'" + txtMaHDBan.Text.Trim() + "'";
            if (Functions.CheckKey(sql))
            {
            ...
            sl = Convert.ToDouble(Functions.GetFieldValues("SELECT soluong FROM hanghoa WHERE mahh = N'" + cboMaHang.SelectedValue + "'"));
            ...
            sql = "INSERT INTO chitiethoadon(mahd,mahh,giamgia,dongia, soluong,thanhtien) VALUES(N'" + txtMaHDBan.Text.Trim() + "',N'" + cboMaHang.SelectedValue + "',N'" + txtGiamGia.Text + "'," + txtDonGia.Text + "," + txtSoLuong.Text + "," + txtThanhTien.Text + ")";
            Functions.RunSQL(sql);
            LoadDataGridView();
            // Cập nhật lại số lượng của mặt hàng vào bảng tblHang
            SLcon = sl - Convert.ToDouble(txtSoLuong.Text);
            sql = "UPDATE hanghoa SET soluong =" + SLcon + " WHERE mahh= N'" + cboMaHang.SelectedValue + "'";
            Functions.RunSQL(sql);
            // Cập nhật lại tổng tiền cho hóa đơn bán
            tong = Convert.ToInt32(Functions.GetFieldValues("SELECT tongtien FROM hoadon WHERE mahd = N'" + txtMaHDBan.Text.ToString() + "'"));
            Tongmoi = tong + Convert.ToInt32(txtThanhTien.Text.ToString());
        ...
        private void cboMaHang_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            str = "SELECT giaban FROM hanghoa WHERE mahh =N'" + cboMaHang.SelectedValue + "'";
        ...
        private void dgvTKHoaDon_DoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if ((MessageBox.Show("Bạn có chắc chắn muốn xóa không?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes))
            {
                ...
                MaHangxoa = dgvTKHoaDon.CurrentRow.Cells["mahh"].Value.ToString();
                SoLuongxoa = Convert.ToDouble(dgvTKHoaDon.CurrentRow.Cells["soluong"].Value.ToString());
                ThanhTienxoa = Convert.ToDouble(dgvTKHoaDon.CurrentRow.Cells["thanhtien"].Value.ToString());
                sql = "DELETE chitiethoadon WHERE mahd=N'" + txtMaHDBan.Text + "' AND mahh = N'" + MaHangxoa + "'";
                Functions.RunSQL(sql);
                ...
                Functions.RunSQL(sql);
                // Cập nhật lại tổng tiền cho hóa đơn bán
                tong = Convert.ToDouble(Functions.GetFieldValues("SELECT tongtien FROM hoadon WHERE mahd = N'" + txtMaHDBan.Text + "'"));
        ...
        private void btnHuy_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Bạn có chắc chắn muốn xóa không?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                string sql = "SELECT mahh,soluong FROM chitiethoadon WHERE mahd = N'" + txtMaHDBan.Text + "'";
                ...
                sql = "DELETE chitiethoadon WHERE mahd=N'" + txtMaHDBan.Text + "'";
                Functions.RunSqlDel(sql);

                //Xóa hóa đơn
                sql = "DELETE hoadon WHERE mahd=N'" + txtMaHDBan.Text + "'";
                Functions.RunSqlDel(sql);
                ResetValue();
                LoadDataGridView();
                btnHuy.Enabled = true;
        ...
        private void btnInHoaDon_Click(object sender, EventArgs e)
        {
            ...
            sql = "SELECT a.mahd, a.ngayban, a.tongtien, b.tenkhach, b.diachi, b.dienthoai, c.tennv FROM hoadon AS a, khachhang AS b, nhanvien AS c WHERE a.mahd = N'" + txtMaHDBan.Text + "' AND a.makhach = b.makhach AND a.manv = c.manv";
            ...
            sql = "SELECT b.tenhh, a.soluong, b.giaban, a.giamgia, a.thanhtien " +
                  ...
                  txtMaHDBan.Text + "' AND a.mahh = b.mahh";
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            txtMaHDBan.Text = cboTimKiem.Text;
            LoadInfoHoaDon();
            LoadDataGridView();
            btnHuy.Enabled = true;
            btnLuu.Enabled = true;
        ...
        {
            Functions.FillCombo("SELECT mahd FROM hoadon", cboTimKiem, "mahd", "mahd");
            cboTimKiem.SelectedIndex = -1;
        }

        private void btnXuat_Click(object sender, EventArgs e)
        {
            FormRPHoaDon rphd = new FormRPHoaDon();
            rphd.ShowDialog();
        }
    }
}
